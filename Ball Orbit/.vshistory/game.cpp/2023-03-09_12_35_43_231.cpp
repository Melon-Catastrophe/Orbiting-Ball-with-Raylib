#include "raylib.h"
#include "..\_build\test.h"   // For testing classes
#include "..\_build\circle.h" // For Circles
#include <cstdlib>
#include <vector>
...
void drawCrosshair(const double& x, const double& y)
{
   DrawRectangle(x, y, 2, 5, RED);
   DrawRectangle(x, y, 5, 2, RED);
}
